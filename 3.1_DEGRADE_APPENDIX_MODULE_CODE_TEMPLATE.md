...
- [DEGRADE Contract](./3._DEGRADE_Contract.md) - диагностический канал, `ctx` shape, observed exits, centralized classification.
- [GuardFlag / SEED Contract](./5._GuardFlagSEED.md) - guard lifecycle, token ownership, release/lock semantics, seed owner-space.
